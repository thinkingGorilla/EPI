...
public class TestConfig {
    /**
     * Represents the path to the source file used for testing or configuration.
     * This variable stores the name or location of the specific file to be utilized
     * during the execution of related test logic or configuration processes.
     */
    ...
    public TestConfig(String sourceFile,
                      String testFile,
                      String testDataFile,
                      long timeoutSeconds,
    ...
    public static TestConfig fromCommandLine(String testFile,
                                             String testDataFile,
                                             long timeoutSeconds,
                                             int numFailedTestsBeforeStop,
        ...
        TestConfig config = new TestConfig(
                "epi_judge_java/epi/" + testFile.replace(".tsv", ".java"),
                testFile,
                testDataFile,
                timeoutSeconds,
        ...
        if (config.testDataDir != null && !config.testDataDir.isEmpty()) {
            if (!Files.isDirectory(Paths.get(config.testDataDir))) {
                String message = String.format("CL: --test_data_dir argument (%s) is not a directory", config.testDataDir);
